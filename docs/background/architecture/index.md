...
| [Pipeline Guide](pipeline_guide.md) | How a call to `aggregate()` flows through the four phases and their stages | Understanding or modifying the aggregation flow. |
