...
- **Code** is omitted — the auto-generated [API Reference](../../../reference/api/index.md) covers individual classes and functions in more detail than a hand-drawn diagram ever could.
